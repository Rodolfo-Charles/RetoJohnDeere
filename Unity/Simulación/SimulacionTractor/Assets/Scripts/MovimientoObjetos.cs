...
public class Step
{
    public int[] harvesterPosition;
    public int[] tractorPosition;
    public int[] containerPosition;
    public int containerLoad;
    public int[][] field;
}
...
public class FarmData
{
    public Step step0;
    public Step step98;
    // Puedes añadir más propiedades según la estructura de tu JSON
}
...
public class MovimientoObjetos : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!recorridoAcabado)
        {
            ...
            {
                case 1:
                    MoverObjetoHaciaCoordenadasIda(0.47f, 0.74f, -49);//-farmData.step98.harvesterPosition[1] - 40);
                    break;

                case 2:
                    MoverObjetoHaciaCoordenadasIda(12.94f, 0.74f, -49);
                    break;

                case 3:
                    MoverObjetoHaciaCoordenadasIda(24.92f, 0.74f, -49);
                    break;
            }
            
            //Debug.Log(farmData.step98.harvesterPosition[1]);
    ...
    void MoverObjetoHaciaCoordenadasIda(float x, float y, int z)
    {
